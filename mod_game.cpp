...
void GameStartup(void)
{
	...
	m[StandardC].Read("GameData/weapons/Weaponfile.txt", "Standard_Cannon");
	m[SuperC].Read("GameData/weapons/Weaponfile.txt", "Super_Cannon");
	m[UberC].Read("GameData/weapons/Weaponfile.txt", "Uber_Cannon");
	m[FlakC].Read("GameData/weapons/Weaponfile.txt", "Flak_Cannon");
	m[Radar_Missile].Read("GameData/weapons/Weaponfile.txt", "Radar_Missile");
	m[Thermal_Missile].Read("GameData/weapons/Weaponfile.txt", "Thermal_Missile");//echan
	m[Jackhammer].Read("GameData/weapons/Weaponfile.txt", "Jackhammer");//echan
	m[Chain_Gun].Read("GameData/weapons/Weaponfile.txt", "Chain_Gun");//echan
	m[Drunk_Missile].Read("GameData/weapons/Weaponfile.txt", "Drunk_Missile");
	m[Sniper].Read("GameData/weapons/Weaponfile.txt", "Sniper");
	m[Carpet].Read("GameData/weapons/Weaponfile.txt", "Carpet_Bomb");
	m[Flamethrower].Read("GameData/weapons/Weaponfile.txt", "Flamethrower"); //echan;
	m[Napalm].Read("GameData/weapons/Weaponfile.txt", "Napalm");
	m[Firestorm].Read("GameData/weapons/Weaponfile.txt", "Firestorm"); //echan	
	m[Earthmover].Read("GameData/weapons/Weaponfile.txt", "Earthmover");
	m[Dirtball].Read("GameData/weapons/Weaponfile.txt", "Dirtball");
	m[Mudslinger].Read("GameData/weapons/Weaponfile.txt", "Mudslinger");
	m[Tracer].Read("GameData/weapons/Weaponfile.txt", "Tracer");
	m[EMP].Read("GameData/weapons/Weaponfile.txt", "EMP");
	m[Artillery].Read("GameData/weapons/Weaponfile.txt", "Artillery");
	m[ICBP].Read("GameData/weapons/Weaponfile.txt", "ICBP");	
