...
{
	POINT position = {
		static_cast<LONG>(this->WeaponMissile.origin[count].x + this->WeaponMissile.changex[count]),
		static_cast<LONG>(this->WeaponMissile.origin[count].y + this->WeaponMissile.changey[count])
	};
